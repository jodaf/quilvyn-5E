...
SRD5E.FEATURES = {
  ...
  'Draconic Presence':
    'Section=magic ' +
    'Note="R60\' Spend 5 Sorcery Points for charm or fright aura for conc or 1 min (DC %V Wis neg)"',
...
SRD5E.SPELLS = {
  ...
  'Aid':
    'School=Abjuration ' +
    'Level=C2,P2 ' +
    'Description="R30\' Three targets gain +5 temporary HP for 8 hr"',
  'Alarm':
    'School=Abjuration ' +
    'Level=R1,W1 ' +
  ...
  'Animal Friendship':
    'School=Enchantment ' +
    'Level=B1,D1,R1 ' +
    'Description="R30\' Target beast convinced of good intent for 1 dy (Wis neg)"',
  'Animal Messenger':
    'School=Enchantment ' +
    'Level=B2,D2,R2 ' +
  ...
  'Animal Shapes':
    'School=Transmutation ' +
    'Level=D8 ' +
    'Description="R30\' Willing targets in range become up to large, CR 4 creatures for conc or 1 dy"',
  'Animate Dead':
    'School=Necromancy ' +
    'Level=C3,W3 ' +
    'Description="R10\' Bones/corpse becomes skeleton/zombie, obeys R60\' self commands for 1 dy"',
  'Animate Objects':
    'School=Transmutation ' +
    'Level=B5,S5,W5 ' +
  ...
  'Arcane Eye':
    'School=Divination ' +
    'Level=W4 ' +
    'Description="R30\' Self see through remote invisible eye w/darkvision that moves 30\'/rd for conc or 1 hr"',
  'Arcane Hand':
    'School=Evocation ' +
    'Level=W5 ' +
  ...
  'Beacon Of Hope':
    ...
    'Description="R30\' Targets gain Adv on Wis and death saves, maximum HP from healing for conc or 1 min"',
  'Bestow Curse':
    'School=Necromancy ' +
    'Level=B3,C3,W3 ' +
  ...
  'Black Tentacles':
    'School=Conjuration ' +
    'Level=W4 ' +
    'Description="R90\' 20\' sq inflicts 3d6 HP bludgeoning and restrains for conc or 1 min (Dex neg, Str or Dex breaks free)"',
  'Blade Barrier':
    'School=Evocation ' +
    'Level=C6 ' +
  ...
  'Blink':
    'School=Transmutation ' +
    'Level=S3,W3 ' +
    'Description="Self ethereal 50% of time for 1 min"',
  'Blur':
    'School=Illusion ' +
    'Level=Desert1,S2,W2 ' +
  ...
  'Chill Touch':
    'School=Necromancy ' +
    'Level=Elf0,K0,S0,W0 ' +
    'Description="R120\' Ranged spell inflicts ${Math.floor((lvl+7)/6)}d8 HP necrotic, undead also suffer Disadv self attack for 1 rd"',
  'Circle Of Death':
    'School=Necromancy ' +
    'Level=K6,S6,W6 ' +
  ...
  'Clairvoyance':
    'School=Divination ' +
    'Level=B3,C3,S3,W3 ' +
    'Description="R1 mile Self see or hear remotely through invisible sensor for conc or 10 min"',
  'Clone':
    'School=Necromancy ' +
    'Level=W8 ' +
  ...
  'Comprehend Languages':
    'School=Divination ' +
    'Level=B1,K1,S1,W1 ' +
    'Description="Selfs understand all languages for 1 hr"',
  'Compulsion':
    'School=Enchantment ' +
    'Level=B4 ' +
  ...
  'Confusion':
    'School=Enchantment ' +
    'Level=B4,D4,S4,W4 ' +
    'Description="R90\' Creatures in 10\' radius randomly 10% wander/50% do nothing/20% attack adjacent/20% act normally for conc or 1 min (Wis neg)"',
  'Conjure Animals':
    'School=Conjuration ' +
    'Level=D3,R3 ' +
  ...
  'Conjure Minor Elementals':
    'School=Conjuration ' +
    'Level=D4,W4 ' +
    'Description="R90\' Summons obedient elements for conc or 1 hr"',
  ...
  'Death Ward':
    'School=Abjuration ' +
    'Level=C4,Life4,P4 ' +
    'Description="Touched keeps 1 HP when next brought to 0 HP for 8 hrs"',
  ...
  'Dispel Magic':
    ...
    'Description="R120\' Ends spell effects up to 3 level on target, higher requires DC 10 + spell level check"',
  'Divination':
    'School=Divination ' +
  ...
  'Dominate Beast':
    'School=Enchantment ' +
    'Level=D4,S4 ' +
    'Description="R60\' Target obeys self telepathic commands for conc or 1 min (Wis neg)"',
  'Dominate Monster':
    'School=Enchantment ' +
    'Level=B8,K8,S8,W8 ' +
    'Description="R60\' Target obeys self telepathic commands for conc or 1 hr (Wis neg)"',
  'Dominate Person':
    'School=Enchantment ' +
    'Level=B5,S5,W5 ' +
    'Description="R60\' Target obeys self telepathic commands for conc or 1 min (Wis neg)"',
  ...
  'Enhance Ability':
    'School=Transmutation ' +
    'Level=B2,C2,D2,S2 ' +
    'Description="Touched gains Adv on chosen ability checks for 1 hr; Con adds +2d6 temporary HP, Str dbl load; Dex no damage from 20\' fall"',
  'Enlarge/Reduce':
    'School=Transmutation ' +
    'Level=S2,W2 ' +
    'Description="R30\' Target becomes dbl (Adv Str, +1d4 weapon damage) or half (Disadv Str, -1d4 weapon damage) size for conc or 1 min"',
  'Entangle':
    'School=Conjuration ' +
    'Level=D1 ' +
    'Description="R90\' Growth ensnares creatures in 20\' sq for conc or 1 min (Str neg)"',
  'Enthrall':
    'School=Enchantment ' +
    'Level=B2,K2 ' +
    'Description="R60\' Target suffers Disadv Perception to notice others for 1 min (Wis neg)"',
  'Etherealness':
    'School=Transmutation ' +
  ...
  'Eyebite':
    'School=Necromancy ' +
    'Level=B6,K6,S6,W6 ' +
    'Description="R60\' Sleep, panic, or sicken (Disadv attack and ability rolls) 1 target/rd for conc or 1 min"',
  ...
  'Faerie Fire':
    'School=Evocation ' +
    'Level=B1,D1 ' +
    'Description="R60\' Objects in 20\' cu glow (foe Adv attack) for conc or 1 min (Dex neg)"',
  'Faithful Hound':
    'School=Conjuration ' +
    'Level=W4 ' +
  ...
  'Fear':
    'School=Illusion ' +
    'Level=B3,K3,S3,W3 ' +
    'Description="Creatures in 30\' cone flee for conc or 1 min (Wis neg)"',
  'Feather Fall':
    'School=Transmutation ' +
    'Level=B1,S1,W1 ' +
  ...
  'Flesh To Stone':
    'School=Transmutation ' +
    'Level=K6,W6 ' +
    'Description="R60\' Target restrained, then petrified after third failed Con saves for conc or 1 min (Con x3 neg)"',
  'Floating Disk':
    'School=Conjuration ' +
    'Level=W1 ' +
  ...
  'Forbiddance':
    'School=Abjuration ' +
    'Level=C6 ' +
    'Description="Touched 40K\' sq bars teleport and portals, inflicts 5d10 HP radiant or necrotic on transit to chosen type for 1 dy"',
  'Forcecage':
    'School=Evocation ' +
    'Level=B7,K7,W7 ' +
  ...
  'Geas':
    ...
    'Description="R60\' Target obeys command for 30 dy (Wis neg)"',
  'Gentle Repose':
    'School=Necromancy ' +
    'Level=C2,W2 ' +
  ...
  'Giant Insect':
    'School=Transmutation ' +
    'Level=D4 ' +
    'Description="R30\' 10 centipedes, 5 wasps, 3 spiders, or 1 scorpion becomes giant and obeys self commands for conc or 10 min"',
  'Glibness':
    'School=Transmutation ' +
    'Level=B8,K8 ' +
  ...
  'Guiding Bolt':
    'School=Evocation ' +
    'Level=C1 ' +
    'Description="R120\' Ranged spell inflicts 4d6 HP radiant, lights target (Adv next foe attack) for 1 rd"',
  'Gust Of Wind':
    'School=Evocation ' +
    'Level=D2,S2,W2 ' +
  ...
  'Hideous Laughter':
    'School=Enchantment ' +
    'Level=B1,W1 ' +
    'Description="R30\' Target ROFL for conc or 1 min (Wis neg)"',
  'Hold Monster':
    'School=Enchantment ' +
    'Level=B5,K5,S5,W5 ' +
  ...
  'Hypnotic Pattern':
    'School=Illusion ' +
    'Level=B3,K3,S3,W3 ' +
    'Description="R120\' creatures in 30\' cu charmed for conc or 1 min (Wis neg)"',
  ...
  'Resistance':
    'School=Abjuration ' +
    'Level=C0,D0 ' +
    'Description="Touched +1d4 on save w/in conc or 1 min"',
  'Resurrection':
    'School=Necromancy ' +
    'Level=B7,C7 ' +
  ...
  'Scrying':
    ...
    'Description="See, hear chosen target (Wis neg) for conc or 10 min"',
  'Secret Chest':
    'School=Conjuration ' +
    'Level=W4 ' +
  ...
  'Shapechange':
    'School=Transmutation ' +
    'Level=D9,W9 ' +
    'Description="Self polymorph for conc or 1 hr/0 HP"',
  'Shatter':
    'School=Evocation ' +
    'Level=B2,K2,S2,W2 ' +
  ...
  'Shield Of Faith':
    'School=Abjuration ' +
    'Level=C1,P1 ' +
    'Description="R60\' Target +2 AC for conc or 10 min"',
  'Shillelagh':
    'School=Transmutation ' +
    'Level=D0 ' +
  ...
  'Silent Image':
    'School=Illusion ' +
    'Level=B1,S1,W1 ' +
    'Description="R60\' 15\' cu illusion for conc or 10 min (Investigation neg)"',
  'Simulacrum':
    'School=Illusion ' +
    'Level=W7 ' +
  ...
  'Spider Climb':
    ...
    'Description="Touched travel walls and ceilings for conc or 1 hr"',
  'Spike Growth':
    'School=Transmutation ' +
    'Level=Arctic1,D2,Mountain1,R2 ' +
    'Description="R150\' 20\' radius 2d4 HP/5\' move for conc or 10 min"',
  'Spirit Guardians':
    'School=Conjuration ' +
    'Level=C3 ' +
  ...
  'Stoneskin':
    ...
    'Description="Touched resistance to bludgeoning, piercing, and slashing damage for conc or 1 hr"',
  'Storm Of Vengeance':
    'School=Conjuration ' +
    'Level=D9 ' +
    'Description="RSight 360\' radius lightning, thunder, wind for conc or 1 min"',
  'Suggestion':
    'School=Enchantment ' +
    'Level=B2,K2,S2,W2 ' +
  ...
  'Sunbeam':
    'School=Evocation ' +
    'Level=D6,S6,W6 ' +
    'Description="60\' light 6d8 HP (Con half), blind 1 tn (Con neg) for conc or 1 min"',
  'Sunburst':
    'School=Evocation ' +
    'Level=D8,S8,W8 ' +
  ...
  'Telekinesis':
    'School=Transmutation ' +
    'Level=S5,W5 ' +
    'Description="R60\' Move 1000 lb 30\'/rd for conc or 10 min (Str neg)"',
  'Telepathic Bond':
    'School=Divination ' +
    'Level=W5 ' +
  ...
  'Tree Stride':
    'School=Conjuration ' +
    'Level=D5,Forest4,R5 ' +
    'Description="Teleport between like trees 1/rd for conc or 1 min"',
  'True Polymorph':
    'School=Transmutation ' +
    'Level=B9,K9,W9 ' +
    'Description="R30\' Target creature or object transformed for conc or 1 hr/0 HP (Wis neg)"',
  'True Resurrection':
    'School=Necromancy ' +
    'Level=C9,D9 ' +
  ...
  'Vampiric Touch':
    'School=Necromancy ' +
    'Level=K3,W3 ' +
    'Description="Touched 3d6 HP, self regain half for conc or 1 min"',
  'Vicious Mockery':
    'School=Enchantment ' +
    'Level=B0 ' +
  ...
  'Wall Of Fire':
    'School=Evocation ' +
    'Level=D4,K4,S4,W4 ' +
    'Description="R120\' 60\'x20\' wall 5d8 HP (Dex half) for conc or 1 min"',
  'Wall Of Force':
    'School=Evocation ' +
    'Level=W5 ' +
    'Description="R120\' 10 10\'x10\' panels impassable by objects for conc or 10 min"',
  'Wall Of Ice':
    'School=Evocation ' +
    'Level=W6 ' +
    'Description="R120\' 10 10\'x10\' panels for conc or 10 min"',
  'Wall Of Stone':
    'School=Evocation ' +
  ...
  'Wall Of Thorns':
    'School=Conjuration ' +
    'Level=D6 ' +
    'Description="R120\' 60\'x10\' wall 7d8 HP (Dex half) for conc or 10 min"',
  'Warding Bond':
    'School=Abjuration ' +
    'Level=C2 ' +
  ...
  'Web':
    'School=Conjuration ' +
    'Level=S2,W2 ' +
    'Description="R60\' 20\' cu restrain creatures for conc or 1 hr (Dex neg, Str frees)"',
  'Weird':
    'School=Illusion ' +
    'Level=W9 ' +
    'Description="R120\' Targets in 30\' radius frightened, 4d10 HP/tn for conc or 1 min (Wis neg)"',
  'Wind Walk':
    'School=Transmutation ' +
    'Level=D6 ' +
  ...
  'Wind Wall':
    'School=Evocation ' +
    'Level=D3,R3 ' +
    'Description="R120\' 50\'x15\' strong wind does 3d8 HP (Str half) for conc or 1 min"',
  'Wish':
    'School=Conjuration ' +
    'Level=S9,W9 ' +
