...
*/
  ...
  rules.defineChoice('skills', FiveE.SKILLS);
  Scribe.addRuleSet(rules);
  FiveE.rules = rules;
}

// JavaScript expressions for several (mostly class-based) attributes.
FiveE.PROFICIENCY_HEAVY = 3;
FiveE.PROFICIENCY_LIGHT = FiveE.PROFICIENCY_SIMPLE = 1;
FiveE.PROFICIENCY_MEDIUM = FiveE.PROFICIENCY_MARTIAL = 2;
FiveE.PROFICIENCY_NONE = 0;
...
FiveE.WEAPONS = [
  ...
  'Trident:d8r20', 'War Pick:d8', 'Whip:d4'
];
...
FiveE.armorsProficiencyLevels = {
  'None':FiveE.PROFICIENCY_NONE, 'Padded':FiveE.PROFICIENCY_LIGHT,
  'Leather':FiveE.PROFICIENCY_LIGHT, 'Studded Leather':FiveE.PROFICIENCY_LIGHT,
  'Hide':FiveE.PROFICIENCY_MEDIUM, 'Chain Shirt':FiveE.PROFICIENCY_LIGHT,
  'Scale Mail':FiveE.PROFICIENCY_MEDIUM, 'Breastplate':FiveE.PROFICIENCY_MEDIUM,
  'Half Plate':FiveE.PROFICIENCY_MEDIUM, 'Ring Mail':FiveE.PROFICIENCY_HEAVY,
  'Chain Mail':FiveE.PROFICIENCY_HEAVY, 'Splint':FiveE.PROFICIENCY_HEAVY,
  'Plate': FiveE.PROFICIENCY_HEAVY
};
...
FiveE.weaponsProficiencyLevels = {

  'Club':FiveE.PROFICIENCY_LIGHT,
  'Dagger':FiveE.PROFICIENCY_LIGHT,
  'Greatclub':FiveE.PROFICIENCY_LIGHT,
  'Handaxe':FiveE.PROFICIENCY_LIGHT,
  'Javelin':FiveE.PROFICIENCY_LIGHT,
  'Light Hammer':FiveE.PROFICIENCY_LIGHT,
  'Mace':FiveE.PROFICIENCY_LIGHT,
  'Quarterstaff':FiveE.PROFICIENCY_LIGHT,
  'Sickle':FiveE.PROFICIENCY_LIGHT,
  'Spear':FiveE.PROFICIENCY_LIGHT,
  'Unarmed':FiveE.PROFICIENCY_LIGHT,

  'Light Crossbow':FiveE.PROFICIENCY_LIGHT,
  'Dart':FiveE.PROFICIENCY_LIGHT,
  'Shortbow':FiveE.PROFICIENCY_LIGHT,
  'Sling':FiveE.PROFICIENCY_LIGHT,

  'Battleaxe':FiveE.PROFICIENCY_MEDIUM,
  'Flail':FiveE.PROFICIENCY_MEDIUM,
  'Glaive':FiveE.PROFICIENCY_MEDIUM,
  'Greataxe':FiveE.PROFICIENCY_MEDIUM,
  'Greatsword':FiveE.PROFICIENCY_MEDIUM,
  'Halberd':FiveE.PROFICIENCY_MEDIUM,
  'Lance':FiveE.PROFICIENCY_MEDIUM,
  'Longsword':FiveE.PROFICIENCY_MEDIUM,
  'Maul':FiveE.PROFICIENCY_MEDIUM,
  'Morningstar':FiveE.PROFICIENCY_MEDIUM,
  'Pike':FiveE.PROFICIENCY_MEDIUM,
  'Rapier':FiveE.PROFICIENCY_MEDIUM,
  'Scimitar':FiveE.PROFICIENCY_MEDIUM,
  'Shortsword':FiveE.PROFICIENCY_MEDIUM,
  'Trident':FiveE.PROFICIENCY_MEDIUM,
  'War Pick':FiveE.PROFICIENCY_MEDIUM,
  'Warhammer':FiveE.PROFICIENCY_MEDIUM,
  'Whip':FiveE.PROFICIENCY_MEDIUM,

  'Blowgun':FiveE.PROFICIENCY_MEDIUM,
  'Hand Crossbow':FiveE.PROFICIENCY_MEDIUM,
  'Heavy Crossbow':FiveE.PROFICIENCY_MEDIUM,
  'Longbow':FiveE.PROFICIENCY_MEDIUM,
  'Net':FiveE.PROFICIENCY_MEDIUM
...
FiveE.backgroundRules = function(rules, backgrounds) {
  for(var i = 0; i < backgrounds.length; i++) {
    rules.defineChoice('backgrounds', backgrounds[i]);
  }
};
...
FiveE.classRules = function(rules, classes) {
  ...
  for(var i = 0; i < classes.length; i++) {
    ...
    var features, hitDie, notes, profArmors, profCounts, profSaves, profShields,
        profSkills, profTools, profWeapons, selectableFeatures, spellAbility,
    ...
    if(klass == 'Barbarian') {
      ...
      notes = [
        ...
        'abilityNotes.fastMovementFeature:+%V speed in light/no armor',
      ...
      profArmors = FiveE.PROFICIENCY_MEDIUM;
      profShields = FiveE.PROFICIENCY_HEAVY;
      profWeapons = FiveE.PROFICIENCY_MARTIAL;
      profSaves = ['Constitution', 'Strength'];
      profTools = null;
      profSkills = [
      ...
      rules.defineRule('abilityNotes.fastMovementFeature', '', '=', '10');
      ...
      profArmors = FiveE.PROFICIENCY_LIGHT;
      profShields = FiveE.PROFICIENCY_HEAVY;
      profWeapons = FiveE.PROFICIENCY_LIGHT;
      profTools = [
        'Bagpipes', 'Drum', 'Dulcimer', 'Flute', 'Lute', 'Lyre', 'Horn',
        'Pan Flute', 'Shawm', 'Viol'
      ];
      profSave = ['Charisma', 'Dexterity'];
      profSkills = FiveE.SKILLS.map(function(skill){return skill.substring(0, skill.indexOf(':'));});
      profCounts = {'Tools':3, 'Skills':3};
      ...
      profShields = FiveE.PROFICIENCY_HEAVY;
      profWeapons = FiveE.PROFICIENCY_LIGHT;
      profSaves = ['Wisdom', 'Charisma'];
      profSkills = ['History', 'Insight', 'Medicine', 'Persuasion', 'Religion'];
      profTools = null;
      profCounts = {'Saves':2, 'Skills': 2};
      selectableFeatures = [
    ...
    FiveE.defineClass
      (rules, klass, hitDie, profArmors, profShields, profWeapons, profTools,
       profSaves, profSkills, profCounts, features, spellsKnown, spellsPerDay,
       spellAbility);
    if(notes != null)
...
FiveE.combatRules = function(rules) {
  ...
  rules.defineRule('armorProficiency',
    'armorProficiencyLevel', '=', 'FiveE.proficiencyLevelNames[source]'
  );
  ...
  rules.defineRule('shieldProficiency',
    'shieldProficiencyLevel', '=', 'FiveE.proficiencyLevelNames[source]'
  );
  ...
  rules.defineRule('weaponProficiency',
    'weaponProficiencyLevel', '=',
      'source == ' + FiveE.PROFICIENCY_LIGHT + ' ? "Simple" : ' +
      'source == ' + FiveE.PROFICIENCY_MEDIUM + ' ? "Martial" : ' +
      '"Limited"'
  );
...
FiveE.equipmentRules = function(rules, armors, goodies, shields, weapons) {
  ...
  rules.defineRule('abilityNotes.armorSpeedAdjustment',
    'armor', '=',
    'FiveE.armorsProficiencyLevels[source] != null && ' +
    'FiveE.armorsProficiencyLevels[source] >= ' + FiveE.PROFICIENCY_MEDIUM +
    ' ? -10 : null',
  ...
  rules.defineNote(
    'combatNotes.nonproficientArmorPenalty:Disadv str/dex checks, no casting',
    'combatNotes.nonproficientShieldPenalty:Disadv str/dex checks, no casting',
    'sanityNotes.armorProficiencyLevelArmor:Disadv str/dex',
    'sanityNotes.shieldProficiencyLevelShield:Disadv str/dex'
  );
  rules.defineRule('armorProficiencyLevelShortfall',
    'armor', '=', 'FiveE.armorsProficiencyLevels[source]',
  ...
  for(var i = 0; i < weapons.length; i++) {
    ...
    rules.defineRule('weaponProficiencyLevelShortfall.' + weapon,
      'weapons.' + weapon, '=',
        'FiveE.weaponsProficiencyLevels["' + weapon + '"]',
...
/*
    if(feat == 'Acrobatic') {
      ...
      if(FiveE.weaponsProficiencyLevels[weapon] == FiveE.PROFICIENCY_HEAVY) {
        notes = notes.concat([
...
FiveE.raceRules = function(rules, languages, races) {
  ...
  for(var i = 0; i < races.length; i++) {
    ...
    var adjustment, features, languages, notes, proficiencies;
    var race = races[i];
    var raceNoSpace =
    ...
    if(race == 'Half-Elf') {
      ...
      notes = [
        ...
        'featureNotes.tranceFeature:' +
          '4 hours meditation gives benefit of 8 hours sleep',
        'saveNotes.feyAncestryFeature:Adv vs. charmed, immune sleep'
      ];
      ...
      if(race == 'High Elf') {
        ...
        proficiencies.push('Longsword', 'Shortsword', 'Shortbow', 'Longbow');
      } else if(race == 'Wood Elf') {
        adjustment += '/+1 wisdom';
        features.push('Mask Of The Wild', 'Quick');
        proficiencies.push('Longsword', 'Shortsword', 'Shortbow', 'Longbow');
        notes.push(
        ...
        notes.push(
          ...
          'magicNotes.drowMagicFeature:Cast <i>Dancing Lights</i> cantrip%V'
        );
        proficiencies.push('Rapier', 'Shortsword', 'Hand Crossbow');
        rules.defineRule('magicNotes.drowMagicFeature', 'level', '=', 'source < 3 ? "" : source < 5 ? ", <i>Faerie Fire</i> 1/day" : ", <i>Faerie Fire</i>, <i>Darkness</i> 1/day"');
      }

    } else if(race.match(/Gnome/)) {

      adjustment = '+2 intelligence';
      features = ['Cunning', 'Slow', 'Small'];
      ...
      if(race == 'Forest Gnome') {
        ...
        notes.push(
          ...
          'magicNotes.naturalIllisionistFeature:Cast <i>Minor Illusion</i> cantrip (int)'
        );
      } else if(race == 'Rock Gnome') {
        adjustment += '/+1 constitution';
        features.push('Artificier\'s Lore', 'Tinker');
        proficiencies.push('Artisan\'s Tools');
      }
      ...
      adjustment = '+2 dexterity';
      features = ['Brave', 'Lucky', 'Nimble', 'Slow', 'Small'];
      ...
      if(race == 'Lightfoot Halfling') {
        ...
        adjustment += '/+1 constitution';
        features = features.concat(['Stout']);
        notes = notes.concat
      ...
      notes = [
        'featureNotes.darkvisionFeature:See one light level better 60\'',
        'magicNotes.infernalLegacyFeature:Cast <i>Thaumaturgy</i> cantrip%V',
        'saveNotes.hellishResistanceFeature:Resistance to fire damage'
      ];

      rules.defineRule('magicNotes.infernalLegacyFeature', 'level', '=', 'source < 3 ? "" : source < 5 ? ", <i>Hellish Rebuke</i> 1/day" : "<i>Hellish Rebuke</i>, <i>Darkness</i> 1/day"');

    } else
      continue;

    FiveE.defineRace
      (rules, race, adjustment, features, languages, proficiencies);
    if(notes != null) {
      rules.defineNote(notes);
    }
...
FiveE.randomizeOneAttribute = function(attributes, attribute) {
  ...
  if(attribute == 'armor') {
    ...
    if(characterProfLevel == null) {
      characterProfLevel = FiveE.PROFICIENCY_NONE;
    }
    choices = [];
    for(attr in this.getChoices('armors')) {
      if((FiveE.armorsProficiencyLevels[attr] != null &&
          FiveE.armorsProficiencyLevels[attr] <= characterProfLevel) ||
    ...
    choices = [];
    if(characterProfLevel != FiveE.PROFICIENCY_NONE) {
      choices = FiveE.SHIELDS;
    }
    if(choices.length > 0) {
    ...
    for(attr in this.getChoices('weapons')) {
      if((FiveE.weaponsProficiencyLevels[attr] != null &&
          FiveE.weaponsProficiencyLevels[attr] <= characterProfLevel) ||
...
FiveE.defineClass = function
  (rules, name, hitDice, armorProficiencyLevel, shieldProficiencyLevel,
   weaponProficiencyLevel, toolProficiencies, saveProficiencies,
   skillProficiencies, proficiencyCounts, features, spellsKnown,
   spellsPerDay, spellAbility) {

  var classLevel = 'levels.' + name;
  rules.defineChoice('levels', name + ':' + hitDice);
  if(armorProficiencyLevel == null)
    armorProficiencyLevel = FiveE.PROFICIENCY_NONE;
  rules.defineRule
    ('classArmorProficiencyLevel', classLevel, '^=', armorProficiencyLevel);
  if(shieldProficiencyLevel == null)
    shieldProficiencyLevel = FiveE.PROFICIENCY_NONE;
  rules.defineRule
    ('classShieldProficiencyLevel', classLevel, '^=', shieldProficiencyLevel);
  if(weaponProficiencyLevel == null)
    weaponProficiencyLevel = FiveE.PROFICIENCY_NONE;
  rules.defineRule
    ('classWeaponProficiencyLevel', classLevel, '^=', weaponProficiencyLevel);
  if(toolProficiencies != null) {
    for(var i = 0; i < toolProficiencies.length; i++) {
      rules.defineRule('classProficiencies.' + toolProficiencies[i], classLevel, '=', '1');
    }
  }
  console.log(saveProficiencies);
  if(saveProficiencies != null) {
    for(var i = 0; i < saveProficiencies.length; i++) {
      rules.defineRule('classProficiencies.' + saveProficiencies[i], classLevel, '=', '1');
    }
  }
  if(skillProficiencies != null) {
    for(var i = 0; i < skillProficiencies.length; i++) {
      rules.defineRules('classProficiencies.' + skillProficiencies[i], classLevel, '=', '1');
    }
  }
  if(proficiencyCounts > 0) {
    for(var a in proficiencyCounts) {
      rules.defineRule('proficiencyCounts.' + a, classLevel, '+=', proficiencyCounts[a]);
    }
  }
  if(features != null) {
    var prefix =
 ...
 */
FiveE.defineRace = function(rules, name, abilityAdjustment, features, languages, proficiencies) {
