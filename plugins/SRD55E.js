 ...
 * the SRD v5.2.1 rules. Similarly, the constant fields of SRD55E
 * (BACKGROUNDS, FEATS, etc.) can be manipulated to modify the choices.
 */
function SRD55E() {

  if(window.SRD5E == null) {
    alert('The SRD55E module requires use of the SRD5E module');
    return;
  }

  let rules = new QuilvynRules('SRD 5.5E', SRD55E.VERSION);
  SRD55E.rules = rules;
  rules.plugin = SRD55E;

  rules.defineChoice('choices', SRD55E.CHOICES);
  rules.choiceEditorElements = SRD55E.choiceEditorElements;
  rules.choiceRules = SRD55E.choiceRules;
  ...
  rules.getPlugins = SRD55E.getPlugins;
  ...
  rules.ruleNotes = SRD55E.ruleNotes;

  SRD55E.createViewers(rules, SRD5E.VIEWERS);
  ...
  SRD55E.combatRules
    (rules, SRD55E.ARMORS, SRD55E.SHIELDS, SRD55E.WEAPONS);
  SRD55E.magicRules(rules, SRD55E.SCHOOLS, SRD55E.SPELLS);
  SRD55E.identityRules(
    rules, SRD55E.ALIGNMENTS, SRD55E.BACKGROUNDS, SRD55E.CLASSES,
    SRD55E.DEITIES, SRD55E.SPECIES
  );
  SRD55E.talentRules
    (rules, SRD55E.FEATS, SRD55E.FEATURES, SRD55E.GOODIES,
     SRD55E.LANGUAGES, SRD55E.SKILLS, SRD55E.TOOLS);

  Quilvyn.addRuleSet(rules);

}

SRD55E.CHOICES = SRD5E.CHOICES.map(x => x.replace('Race', 'Species'));
SRD55E.RANDOMIZABLE_ATTRIBUTES = [].concat(SRD5E.RANDOMIZABLE_ATTRIBUTES);
SRD55E.VERSION = '2.4.1.0';
SRD55E.VIEWERS = [].concat(SRD5E.VIEWERS);

SRD55E.ABILITIES = Object.assign({}, SRD5E.ABILITIES);
SRD55E.ALIGNMENTS = Object.assign({}, SRD5E.ALIGNMENTS);
SRD55E.ARMORS = Object.assign({}, SRD5E.ARMORS);
SRD55E.BACKGROUNDS = {
  'Acolyte':
    'Equipment=' +
...
SRD55E.GOODIES = Object.assign({}, SRD5E.GOODIES);
SRD55E.LANGUAGES = {
  // Standard
  'Common':'',
...
SRD55E.SCHOOLS = Object.assign({}, SRD5E.SCHOOLS);
SRD55E.SHIELDS = Object.assign({}, SRD5E.SHIELDS);
SRD55E.SKILLS = Object.assign({}, SRD5E.SKILLS);
...
SRD55E.abilityRules = function(rules, abilities) {
  SRD5E.abilityRules(rules, abilities);
  // No changes needed to SRD5E
};

/* Defines the rules related to combat. */
SRD55E.combatRules = function(rules, armors, shields, weapons) {
  SRD5E.combatRules(rules, armors, shields, weapons);
  // No changes needed to SRD5E
};

/* Defines rules related to basic character identity. */
SRD55E.identityRules = function(
...
SRD55E.magicRules = function(rules, schools, spells) {
  SRD5E.magicRules(rules, schools, spells);
  // No changes needed to SRD5E
};

/* Defines rules related to character aptitudes. */
SRD55E.talentRules = function(
 ...
 */
SRD55E.choiceRules = function(rules, type, name, attrs) {
  if(type == 'Alignment')
    SRD55E.alignmentRules(rules, name);
  else if(type == 'Armor') {
    let bulky = QuilvynUtils.getAttrValue(attrs, 'Bulky');
    SRD55E.armorRules(rules, name,
    ...
    SRD55E.classRulesExtra(rules, name);
  } else if(type == 'Class Feature')
    SRD55E.classFeatureRules(rules, name,
      QuilvynUtils.getAttrValueArray(attrs, 'Require'),
    ...
    SRD55E.deityRules(rules, name,
      QuilvynUtils.getAttrValue(attrs, 'Alignment'),
      QuilvynUtils.getAttrValueArray(attrs, 'Domain')
    );
  else if(type == 'Feat') {
    SRD55E.featRules(rules, name,
      QuilvynUtils.getAttrValueArray(attrs, 'Require'),
      QuilvynUtils.getAttrValueArray(attrs, 'Imply'),
      QuilvynUtils.getAttrValueArray(attrs, 'Category')
    );
    SRD55E.featRulesExtra(rules, name);
  } else if(type == 'Feature')
    SRD55E.featureRules(rules, name,
    ...
    SRD55E.languageRules(rules, name);
  else if(type == 'School')
    SRD55E.schoolRules(rules, name);
  else if(type == 'Shield')
    SRD55E.shieldRules(rules, name,
      QuilvynUtils.getAttrValue(attrs, 'AC'),
      QuilvynUtils.getAttrValue(attrs, 'Cost'),
      QuilvynUtils.getAttrValue(attrs, 'Weight')
    );
  else if(type == 'Skill')
    SRD55E.skillRules(rules, name,
      QuilvynUtils.getAttrValue(attrs, 'Ability')
    );
  else if(type == 'Species' || type == 'Race') {
    SRD55E.speciesRules(rules, name,
      QuilvynUtils.getAttrValueArray(attrs, 'Require'),
      QuilvynUtils.getAttrValueArray(attrs, 'Features'),
      QuilvynUtils.getAttrValueArray(attrs, 'Selectables'),
    ...
    SRD55E.speciesRulesExtra(rules, name);
  } else if(type == 'Species Feature' || type == 'Race Feature')
    SRD55E.speciesFeatureRules(rules, name,
      QuilvynUtils.getAttrValueArray(attrs, 'Require'),
...
SRD55E.alignmentRules = function(rules, name) {
 ...
 */
SRD55E.backgroundRules = function(rules, name, equipment, features) {
 ...
 * replaces.
 */
SRD55E.backgroundFeatureRules = function(
 ...
 */
SRD55E.classRulesExtra = function(rules, name) {
 ...
 * replaces.
 */
SRD55E.classFeatureRules = function(
 ...
 */
SRD55E.deityRules = function(rules, name, alignment, domains) {
 ...
 */
SRD55E.featRules = function(rules, name, requires, implies, categories) {
 ...
 */
SRD55E.featRulesExtra = function(rules, name) {
 ...
 */
SRD55E.featureSpells = function(rules, feature, spellType, levelAttr, spellList){
 ...
 */
SRD55E.speciesRulesExtra = function(rules, name) {
 ...
 */
SRD55E.speciesFeatureRules = function(
 ...
 */
SRD55E.shieldRules = function(rules, name, ac, cost, weight) {
 ...
 */
SRD55E.skillRules = function(rules, name, ability) {
 ...
 */
SRD55E.toolRules = function(rules, name, category, cost, weight, ability) {
...
SRD55E.spellsAvailableRules = SRD5E.spellsAvailableRules;

/* Returns an ObjectViewer loaded with the default character sheet format. */
SRD55E.createViewers = function(rules, viewers) {
...
SRD55E.randomizeOneAttribute = function(attributes, attribute) {
 ...
 */
SRD55E.getChoices = function(name) {
 ...
 */
SRD55E.getFormats = function(rules, viewer) {
  return SRD5E.getFormats(rules, viewer);
};

/* Returns an array of plugins upon which this one depends. */
SRD55E.getPlugins = function() {
  let result = [SRD5E];
  return result;
};
